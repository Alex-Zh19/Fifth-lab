...
public class Display extends JPanel {
    ...
    public Display() {
        ...
        graphicsStroke1 = new BasicStroke(3.0f, BasicStroke.CAP_BUTT,
                BasicStroke.JOIN_ROUND, 10.0f, new float[]{10,1,1,1,1,1,1,2,1,1,1,2}, 0.0f);gridStroke = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.0f, null, 0.0f);
